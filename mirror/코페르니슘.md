...
[IUPAC](IUPAC.md)의 명명법에 따라 잠정적으로 운운바이움이라 불리고 있었다가 2010년 2월 19일 [공식명칭으로 등록되었
다](http://news.naver.com/main/read.nhn?mode=LSD&mid=sec&sid1=105&oid=001&aid=0
003140478).

이 원소는 [수은](%EC%88%98%EC%9D%80.md) 밑에 위치해 있다. 따라서 이 원소는 수은과 비슷하게 상온에서 액체일
것이라고 추측된다. 이름의 유래는 [지동설](%EC%A7%80%EB%8F%99%EC%84%A4.md)을 제창한 천문학자
[코페르니쿠스](%EC%BD%94%ED%8E%98%EB%A5%B4%EB%8B%88%EC%BF%A0%EC%8A%A4.md) `[1]`

1996년 9월에 [독일](%EB%8F%85%EC%9D%BC.md)의 중이온 연구소(GSI)에서 120m길이의 분자가속기를 사용해
[납](%EB%82%A9.md) 원자에 [아연](%EC%95%84%EC%97%B0.md) 이온 빔을 쏘아 두 원소를 결합시켜
새로운 원소의 핵을 만들어냈다. 검출한 원자의 개수는 여태까지 4개이다.

발견자는 독일의 지구르트 호프만 (Sigurd Hofmann), 빅터 리노프(Victor Ninov) 박사팀.`[2]`

당초 제안된 기호는 Cp였으나 이전에 '카시오페이움(지금의 [루테튬](%EB%A3%A8%ED%85%8C%ED%8A%AC.md))'에
사용되었기 때문에, 혼란을 피하기 위해 Cn으로 변경되었다.

`\----`

  * `[1]` 2월 19일은 코페르니쿠스의 생일이다
  * `[2]` 이것 때문에 빅터 리노프의 원소 발견 조작 사건이 밝혀지자 이 발견도 가짜가 아닌지 재검증을 받기도 했다
