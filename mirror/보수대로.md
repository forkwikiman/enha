...
[중구](%EC%A4%91%EA%B5%AC%28%EB%B6%80%EC%82%B0%29.md) 남포동에 있는 자갈치삼거리부터
[사상구](%EC%82%AC%EC%83%81%EA%B5%AC.md) 학장동까지 이어지는 길이 X.Xkm, 왕복 4~10차선의 도로이다.
이 도로의 특징인 하천인 보수천(寶水川)을 복개하여 만든 도로이다. 원래는 도로의 종점이 사상구청까지이였으나, 학장동에서 사상구청 구간을
나누어서 학감대로를 만들어서, 학장동 구덕터널입구까지 줄어들었다.
