...
![http://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Histidin_-
_Histidine.svg/500px-Histidin_-
_Histidine.svg.png](http://upload.wikimedia.org/wikipedia/commons/thumb/1/18
/Histidin_-_Histidine.svg/500px-Histidin_-_Histidine.svg.png)

[[PNG external
image]](http://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Histidin_-
_Histidine.svg/500px-Histidin_-_Histidine.svg.png)

Histidine. [아미노산](%EC%95%84%EB%AF%B8%EB%85%B8%EC%82%B0.md)의 하나로, **성장기의
아동**에게 필요한 조건부 필수 아미노산. 아민기가 있는
[아르기닌](%EC%95%84%EB%A5%B4%EA%B8%B0%EB%8B%8C.md),
[라이신](%EB%9D%BC%EC%9D%B4%EC%8B%A0.md)과 함께 이미다졸(imidazole) 작용기 덕분에
**[염기성](%EC%97%BC%EA%B8%B0.md)을 띤다.** <del>세상에 [산성](%EC%82%B0#s-6.md)이
아니었어</del>`[1]` 간단하게 His 내지는 H로 표현한다.

디아조벤젠술폰산이라는 [지시약](%EC%A7%80%EC%8B%9C%EC%95%BD.md)과 반응하여 **핏빛으로 변한다.**`[2]`

[근육](%EA%B7%BC%EC%9C%A1.md)을 구성하는 성분 중 하나인 카르노신에 쓰이기 때문에 [단백질보충제](%EB%8B%A8%EB%B0%B1%EC%A7%88%20%EB%B3%B4%EC%B6%A9%EC%A0%9C.md)에 포함되어 있는
경우가 많다. 또한 [위액](%EC%9C%84%EC%95%A1.md) 분비 촉진,
[혈구](%ED%98%88%EA%B5%AC.md) 생성, 관절염 및
[알레르기](%EC%95%8C%EB%A0%88%EB%A5%B4%EA%B8%B0.md) 증상 개선,
[신경](%EC%8B%A0%EA%B2%BD.md)세포 보호, [중금속](%EC%A4%91%EA%B8%88%EC%86%8D.md)
및 **[방사선](%EB%B0%A9%EC%82%AC%EC%84%A0.md)**에 대한 저항력 증가 등의 기능이 알려져 있다.
<del>또한 [정력](%EC%A0%95%EB%A0%A5.md)에 좋다고
[카더라](%EC%B9%B4%EB%8D%94%EB%9D%BC.md)</del>

참고로 곁가지의 두 개의 질소 원자 모두가 수소를 받았다가 내놓았다가를 할 수 있는데`[3]` 이러한 성질이 효소 반응에서 유용하다. 그래서
많은 효소 반응에서 중심적인 역할을 한다. 이미다졸 작용기의 pKa가 약 7으로 몸의 pH 조건과도 맞아서 이러한 능력이 더욱 향상된다.

아미노산 중에서 유일하게 이미다졸(imidazole) 작용기를 가지고 있는데, 이 이미다졸에 있는 N(질소)는 쉽게 H(수소)를 잃어버리기
때문에, 음극성을 띄게 된다. 이러한 음극성으로 인해, 양극성을 띄는 다양한 금속들과 bond를 형성할 수 있다. 이 금속 resin과의
결합을 이용하여 단백질 분리정제에 사용되기도 한다.

`\----`

  * `[1]` 애시당초 아미노산의 명칭 자체는 작용기에 카복실기(-C(=O)-OH)가 있어서 ~산이라는 명칭이 붙는 것. 사실 산성을 띠는 아미노산은 [글루탐산](%EA%B8%80%EB%A3%A8%ED%83%90%EC%82%B0.md)과 [아스파르트산](%EC%95%84%EC%8A%A4%ED%8C%8C%EB%A5%B4%ED%8A%B8%EC%82%B0.md) 둘 뿐이다.
  * `[2]` 이것을 파울리 반응이라고 한다.
  * `[3]` 이를 general base, general acid catalysis라고 한다.
